        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a
                href="/#hero"
                className="font-body text-primary hover:text-luxury-gold transition-colors duration-300"
              >
                Willkommen
              </a>
              <a
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-2 space-y-2 pb-4 px-4 bg-white/90 backdrop-blur-sm border-t border-primary/10">
              <a
                href="/#hero"
                className="block font-body text-primary hover:text-luxury-gold transition-colors duration-300"
              >
                Willkommen
              </a>
              <a
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 animate-fade-in-up">
            ...
            <p className="font-body text-xl text-primary/70 max-w-3xl mx-auto leading-relaxed mb-6">
              Entdecken Sie alle Kollektionen und finden Sie den perfekten Stein
              für Ihr Projekt.
            </p>
                ...
                {showDropdown && (
                  <div className="absolute left-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                    <button
                      ...
                      className={`block px-5 py-2 w-full text-left hover:bg-gray-100 ${
                        filter === "Indien" ? "bg-primary text-white" : ""
                      }`}
                    >
                      Indien
                    </button>
                    <button
                      ...
                      className={`block px-5 py-2 w-full text-left hover:bg-gray-100 ${
                        filter === "Quarzit" ? "bg-primary text-white" : ""
                      }`}
                    >
                      Quarzit
                    </button>
                ...
                <div className="relative overflow-hidden group">
                  ...
                  <div className="absolute inset-0 bg-primary/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <div className="text-center text-white p-6">
                      <p className="font-body text-sm mb-2 uppercase tracking-wide">
                        Herkunft
                      </p>
                      <p className="font-luxury text-lg mb-4">
                        {marble.origin}
                      </p>
                    </div>
                  </div>
      ...
      <footer className="bg-primary text-primary-foreground py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="font-luxury text-xl font-semibold mb-4 text-luxury-gold">
                Schnellzugriffe
              </h3>
          ...
          <div className="border-t border-primary-foreground/20 mt-12 pt-8 text-center font-body text-primary-foreground/60">
            <p>
              &copy; 2025 Rama Shehu Natursteine. Alle Rechte vorbehalten. Stein
              für Stein - Qualität aus der Natur.
            </p>
          </div>
        </div>
      </footer>
